...
Note: Adding the domain to Vercel will require updating DNS at your registrar to point A to `216.198.79.1` (Vercel). If you want GitHub Pages instead, point DNS to the GitHub Pages A records (185.199.108.153, 185.199.109.153, 185.199.110.153, 185.199.111.153) and remove the domain from Vercel to avoid conflicts.
